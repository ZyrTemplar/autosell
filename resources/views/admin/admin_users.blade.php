        ...
        <div class="row">
            <div class="col d-flex flex-column flex-shrink-0 p-3 text-white bg-dark ml-3 mt-3" style="width: 380px; border-radius: 30px; height: 100%">
                ...
                <ul class="nav nav-pills flex-column pb-2 mb-auto">
                    <li class="nav-item">
                        <a href="{{route('admin_autos')}}" class="nav-link my-1  text-white menu-li" id="chosen" aria-current="page">
                            Автомобілі
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin_users')}}" class="nav-link my-1 active-custom text-white menu-li" id="my_auto">
                            Користувачі
                        </a>
                    </li>
                </ul>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                <h2 class="mt-3">Список користувачів</h2>
                    ...
                    <table class="table table-striped table-bordered table-sm">
                        ...
                        @foreach($users as $value)
                            <tr>
                                ...
                                <td>{{$value->number}}</td>
                                <td>
                                    <form class="text-center" action="{{route('admin_deleteUser')}}" method="post">
                                        @csrf
